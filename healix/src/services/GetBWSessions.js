...
export async function fetchBodyWeightEntriesCount() {
    try {
        ...
        const BWSessionsCount = fitnessQuery.length;

        console.log(`Total weightlifting entries for user: ${BWSessionsCount}`);
        return {BWSessionsCount };
